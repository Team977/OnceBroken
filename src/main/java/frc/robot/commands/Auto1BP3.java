...
public class Auto1BP3 extends SequentialCommandGroup {
  /** Creates a new Auto1. */
  public Auto1BP3(DrivetrainSubsystem m_drive, Shooter m_shooter, Limelight m_limelight, Intake m_intake) {
    ...
    addCommands(
      new SequentialCommandGroup(
        ...
        new SequentialCommandGroup(
          ...
          //new SetGyroAdjustmentTeleop(m_drive,Constants.pos3theta)
        )
