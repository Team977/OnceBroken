...
public class Auto3BP1 extends SequentialCommandGroup {
  /** Creates a new Auto1. */
  public Auto3BP1(DrivetrainSubsystem m_drive, Shooter m_shooter, Limelight m_limelight, Intake m_intake) {
    ...
    addCommands(
      new SequentialCommandGroup(
        ...
        new SequentialCommandGroup(
          new OdometryDriveCommand(m_drive, Constants.approach2X,Constants.approach2Y, Constants.approach2theta).withTimeout(Constants.AutoMoveTimeout),
          new ParallelRaceGroup(
            new AutoIntakeStart(m_intake),
            new OdometryDriveCommand(m_drive, Constants.ball2Xpos,Constants.ball2Ypos, Constants.approach2theta).withTimeout(Constants.AutoMoveTimeout)
          ),
          new OdometryDriveCommand(m_drive, Constants.approach4X,Constants.approach4Y, Constants.approach4theta).withTimeout(Constants.AutoMoveTimeout),
          new ParallelRaceGroup(
            new AutoIntakeStart(m_intake),
