...
public class ProfiledOdometryDrive extends CommandBase {
  ...
  private Constraints m_Constraints = new TrapezoidProfile.Constraints(1.5, 1);
  ...
  public void initialize() {
    xController = new ProfiledPIDController(2.5, 0.8, 0, m_Constraints);
    yController = new ProfiledPIDController(2.5, 0.8, 0, m_Constraints);
    rController = new ProfiledPIDController(.150, 0.5, 0, m_Constraints);
